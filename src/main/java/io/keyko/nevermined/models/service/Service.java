...
//        final Condition condition = attributes.serviceAgreementTemplate.conditions.stream()
//                .filter(s -> s.name == "_amounts")
//                .findFirst()
//                .orElseThrow(() -> new DDOException("Unable to find the _amounts parameter"));
//        for (Object _someAmount: (ArrayList) condition.getParameterByName("_amounts").value) {
...
//        final Condition condition = attributes.serviceAgreementTemplate.conditions.stream()
//                .filter(s -> s.name == "_receivers")
//                .findFirst()
//                .orElseThrow(() -> new DDOException("Unable to find the _receivers parameter"));
//
//        return ((List<String>) condition.getParameterByName("_receivers").value)
...
//        return (String) condition.getParameterByName(paramName).value;
...
//    }
//
//    public String buildLockPaymentConditionId(String serviceAgreementId, String escrowRewardAddress, String lockRewardConditionAddress) throws UnsupportedEncodingException {
//
//        Condition lockRewardCondition = this.getConditionbyName(Condition.ConditionTypes.lockPayment.toString());
//
