...
//
//        String lockRewardId = accessService.buildLockPaymentConditionId(agreementId, escrowRewardConditionAddress, lockRewardConditionAddress);
//        assertEquals("0x816926c38a73dae566c2b539a2cbac9ff36cda7573fc3b7f30b49a8e5bdfb21c", lockRewardId);
//
//        String accessSecretStoreId = accessService.generateAccessConditionId(agreementId, consumerAddress, accessSecretStoreConditionAddress);
...
//        assertEquals("0x49e787fe03310f7bf344a1244bee0cdd250ea3d2b226844f22c3a96b585103ee", escrowRewardId);
//
//    }
//
//
...
//        conditionsAddresses.put("escrowPaymentAddress", escrowRewardConditionAddress);
//        conditionsAddresses.put("lockPaymentConditionAddress", lockRewardConditionAddress);
//        conditionsAddresses.put("accessConditionAddress", accessSecretStoreConditionAddress);
//
////        String hash= accessService.generateServiceAgreementHash(agreementId, consumerAddress, publisherAddress,conditionsAddresses);
////        assertEquals("0x981c79482112d703fe349ff1da760eb35c04bb945262338e4fe2dad79a2aeeb4", hash);
//
//    }
...
//
//        Map<String, String> conditionsAddresses = new HashMap<>();
//        conditionsAddresses.put("escrowPaymentAddress", "escrowRewardAddredd");
//        conditionsAddresses.put("lockPaymentConditionAddress", "lockRewardAddress");
//        conditionsAddresses.put("accessConditionAddress", "accessSecretStoreADdress");
//
