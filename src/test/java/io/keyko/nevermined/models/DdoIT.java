...
public class DdoIT {
    ...
    private static final String NFT_EXAMPLE_URL = "https://raw.githubusercontent.com/nevermined-io/docs/master/docs/architecture/specs/examples/access/v0.1/ddo_nft.json";
    ...
    private static String NFT_EXAMPLE_CONTENT;
    ...
    public static void setUp() throws Exception {
        ...
        NFT_EXAMPLE_CONTENT = IOUtils.toString(new URI(NFT_EXAMPLE_URL), "utf-8");
    ...
    public void testDDOServicesOrder() throws Exception {
        ...
        DDO ddo= DDO.integrityBuilder(ddoFromJson, credentials);
    ...
    @Test
    public void testNFTServices() throws Exception {

        log.debug("testNFTServices");
        DDO ddo = DDO.fromJSON(new TypeReference<DDO>() {}, NFT_EXAMPLE_CONTENT);
        SortedMap<String, String> checksums = DDO.generateChecksums(ddo);
        assertEquals(3, checksums.size());
        assertEquals("6016a51fd73d6f3157c66062eb8bdee8ad676d13d12e42f1df1e26eb3a02f5f0", checksums.get("0"));
        assertEquals("fde97872ab0a60f04d6234f163ffbcea193814a2654a26dfc6ec430fdcdf2939", checksums.get("6"));
        assertEquals("14f2ea729f662a12efc8afe6890667283f3c0b6f3061c45a57ba43e65a1284d9", checksums.get("7"));

        DID did = DID.builder(ddo.toJson(ddo.proof.checksum));
        log.debug("Did generated from checksums: " + did.did);
        assertEquals(64, did.getHash().length());
        assertEquals("did:nv:006265b5ed49b7953755811bbc0e143c5db3edf26f8a3174ef78aee328bd6a8c", did.did);
